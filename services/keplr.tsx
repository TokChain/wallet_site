...
export const connectKeplr = async () => {
  ...
  if (!window.getOfflineSigner || !window.keplr) {
    ...
    if (window.keplr.experimentalSuggestChain) {
      ...
      // )
      // const my_coinDenom = process.env.NEXT_PUBLIC_STAKING_DENOM
      ...
      try {
        ...
        await window.keplr.experimentalSuggestChain({
          ...
          stakeCurrency: {
            ...
            coinDenom: process.env.NEXT_PUBLIC_MAIN_DENOM, //stakingDenom,
          ...
          feeCurrencies: [
            {
              // Coin denomination to be displayed to the user.
              coinDenom: process.env.NEXT_PUBLIC_MAIN_DENOM,
              // Actual denom (i.e. uatom, uscrt) used by the blockchain.
              coinMinimalDenom: process.env.NEXT_PUBLIC_STAKING_DENOM,
              // # of decimal points to convert minimal denomination to user-facing denomination.
              coinDecimals: 18,
